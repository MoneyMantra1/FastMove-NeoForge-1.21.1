...
public class FastMove {
    ...
    private static void registerPayloads(RegisterPayloadHandlersEvent event) {
        ...
        registrar.playBidirectional(MoveStatePayload.TYPE, MoveStatePayload.STREAM_CODEC, FastMove::handleMoveStateServer);
        registrar.playToClient(ConfigStatePayload.TYPE, ConfigStatePayload.STREAM_CODEC);
    }
